...
DEFAULT_CAREER_SOURCES = [
    ...
    {
        "name": "Academic Work — Data & IT",
        "url": "https://www.academicwork.se/lediga-jobb?q=data",
    },
    {
        "name": "TNG — IT & Data",
        "url": "https://www.tng.se/lediga-jobb/?searchQuery=data+engineer",
    },
    {"name": "Nexer Group — Karriär", "url": "https://www.nexergroup.com/karriar/"},
    {
        "name": "Knowit — Lediga tjänster",
        "url": "https://www.knowit.se/karriar/lediga-tjanster/",
    },
    ...
    {
        "name": "Accenture Sverige — Karriär",
        "url": "https://www.accenture.com/se-en/careers",
    },
    {
        "name": "Capgemini Sverige — Karriär",
        "url": "https://www.capgemini.com/se-en/careers/",
    },
    ...
    {
        "name": "IKEA — Lediga jobb",
        "url": "https://www.ikea.com/se/sv/this-is-ikea/work-with-us/",
    },
    ...
    {
        "name": "Atlas Copco — Careers",
        "url": "https://www.atlascopco.com/en-us/careers",
    },
    {
        "name": "Scania — Karriär",
        "url": "https://www.scania.com/se/sv/home/karriar.html",
    },
    {"name": "Vattenfall — Karriär", "url": "https://www.vattenfall.se/karriar/"},
    {"name": "Volvo Cars — Jobs", "url": "https://jobs.volvocars.com/"},
    {
        "name": "Swedbank — Karriär",
        "url": "https://www.swedbank.com/sv/om-swedbank/karriar.html",
    },
    {"name": "Tele2 — Karriär", "url": "https://www.tele2.com/sv/om-tele2/karriar/"},
    # --- Fintech & bank ---
    {
        "name": "Avanza — Karriär",
        "url": "https://www.avanza.se/om-avanza/jobba-hos-oss.html",
    },
    {
        "name": "Nordnet — Karriär",
        "url": "https://www.nordnet.se/se/om-nordnet/om-foretaget/jobba-hos-oss.html",
    },
    {
        "name": "Klarna — Engineering",
        "url": "https://www.klarna.com/careers/engineering/",
    },
]
...
def _find_job_links(
    soup: BeautifulSoup, base_url: str, patterns: list[str]
) -> list[str]:
...
def fetch_from_board(board: dict, keyword: str, log=None) -> list[dict]:
    ...
    if not links:
        log(
            f"[{board['name']}] '{keyword}': inga jobb-länkar hittades (JS-renderad sida?)"
        )
        return []
